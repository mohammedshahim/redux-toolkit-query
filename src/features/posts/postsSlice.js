...
export const extendApliSlice = apiSlice.injectEndpoints({
    endpoints: builder => ({
        ...
        addReaction: builder.mutation({
            ...
            async onQueryStarted({ postId, reactions }, { dispatch, queryFulfilled }) {
                const patchResult = dispatch(
                    extendApliSlice.util.updateQueryData('getPosts', undefined, (draft) => {
...
export const selectPostsResult = extendApliSlice.endpoints.getPosts.select()
